...
export const ALL_CHAPTERS: ChapterMeta[] = [
  { id: "ch01", number: "第 1 章", titleZh: "导论", titleEn: "Introduction", href: "/chapters/ch01" },
  { id: "ch02", number: "第 2 章", titleZh: "RLHF 简史", titleEn: "A Tiny History of RLHF", href: "/chapters/ch02" },
  { id: "ch03", number: "第 3 章", titleZh: "训练总览", titleEn: "Training Overview", href: "/chapters/ch03" },
  { id: "ch04", number: "第 4 章", titleZh: "指令微调", titleEn: "Instruction Fine-Tuning", href: "/chapters/ch04" },
  { id: "ch05", number: "第 5 章", titleZh: "奖励模型", titleEn: "Reward Modeling", href: "/chapters/ch05" },
  { id: "ch06", number: "第 6 章", titleZh: "强化学习", titleEn: "Reinforcement Learning", href: "/chapters/ch06" },
  { id: "ch07", number: "第 7 章", titleZh: "推理与推理时扩展", titleEn: "Reasoning & Inference-Time Scaling", href: "/chapters/ch07" },
  { id: "ch08", number: "第 8 章", titleZh: "直接对齐算法", titleEn: "Direct-Alignment Algorithms", href: "/chapters/ch08" },
  { id: "ch09", number: "第 9 章", titleZh: "拒绝采样", titleEn: "Rejection Sampling", href: "/chapters/ch09" },
  { id: "ch10", number: "第 10 章", titleZh: "偏好的本质", titleEn: "The Nature of Preferences", href: "/chapters/ch10" },
  { id: "ch11", number: "第 11 章", titleZh: "偏好数据", titleEn: "Preference Data", href: "/chapters/ch11" },
  { id: "ch12", number: "第 12 章", titleZh: "合成数据与蒸馏", titleEn: "Synthetic Data & Distillation", href: "/chapters/ch12" },
  { id: "ch13", number: "第 13 章", titleZh: "工具使用与函数调用", titleEn: "Tool Use & Function Calling", href: "/chapters/ch13" },
  { id: "ch14", number: "第 14 章", titleZh: "过度优化", titleEn: "Over-Optimization", href: "/chapters/ch14" },
  { id: "ch15", number: "第 15 章", titleZh: "正则化", titleEn: "Regularization", href: "/chapters/ch15" },
  { id: "ch16", number: "第 16 章", titleZh: "评估", titleEn: "Evaluation", href: "/chapters/ch16" },
  { id: "ch17", number: "第 17 章", titleZh: "打造模型性格与产品", titleEn: "Model Character & Products", href: "/chapters/ch17" },
  { id: "appa", number: "附录 A", titleZh: "定义", titleEn: "Definitions", href: "/chapters/appa" },
  { id: "appb", number: "附录 B", titleZh: "不只是「风格」", titleEn: 'Beyond "Just Style"', href: "/chapters/appb" },
  { id: "appc", number: "附录 C", titleZh: "实务议题", titleEn: "Practical Issues", href: "/chapters/appc" },
  { id: "bibliography", number: "参考文献", titleZh: "参考文献", titleEn: "Bibliography", href: "/chapters/bibliography" },
];
...
const RAW_DIR = join(process.cwd(), "src/data/chapters-raw-zh-cn");
